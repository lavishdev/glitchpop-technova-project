...
export const Sidebar: React.FC<SidebarProps> = ({ isMobileOpen = false, onMobileClose }) => {
  ...
  return (
    <>
      ...
      >
        {/* Brand Header */}
        <div className="flex items-center justify-between h-16 px-4 border-b border-outline-variant/40">
          ...
          <button
            ...
            className="hidden md:flex items-center justify-center w-8 h-8 rounded-lg text-on-surface-variant hover:bg-surface-container transition-colors"
        ...
        <div className="p-3 border-t border-outline-variant/40 bg-surface-container-low/50">
          {!isCollapsed ? (
            <div className="flex items-center gap-3 px-2 py-2 rounded-lg bg-surface-container-high/40">
